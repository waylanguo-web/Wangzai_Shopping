                            ...
                            <form class="row g-3" wire:submit.prevent="updatePassword">
                                <div class="col-12">
                                    ...
                                    <input type="password"
                                        ...
                                        placeholder="{{ __('Current Password') }}" wire:model="current_password">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="password"
                                        ...
                                        placeholder="{{ __('New Password') }}" wire:model="new_password">
                                    @error('new_password')
                                        <span class="invalid-feedback"> {{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-6">
                                    ...
                                    <input type="password"
                                        ...
                                        placeholder="{{ __('Confirm Password') }}" wire:model="confirm_password">
            ...
            <div class="card shadow-sm border-0 overflow-hidden">
                <div class="card-body">
                    <form wire:submit.prevent="updateProfileImage">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-primary px-4">{{ __('Update Photo') }}</button>
                        </div>
                    </form>
                </div>
            </div>
