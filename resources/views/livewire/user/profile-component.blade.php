                                ...
                                <div class="profile-section">
                                    <div class="row g-4">
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="product-wrapper">
                                                <div class="wrapper-img">
                                                    <span><i class="fa-solid fa-clock fa-2xl" style="color: #AE1C9A"></i></span>
                                                </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="product-wrapper">
                                                <div class="wrapper-img">
                                                    <span><i class="fa-solid fa-box fa-2xl" style="color: #AE1C9A"></i></span>
                                                </div>
                                                <div class="wrapper-content">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="product-wrapper">
                                                <div class="wrapper-img">
                                                    <span><i class="fa-solid fa-truck-fast fa-2xl" style="color: #AE1C9A"></i></span>
                                                </div>
                                                <div class="wrapper-content">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="product-wrapper">
                                                <div class="wrapper-img">
                                                    <span><i class="fa-solid fa-circle-check fa-2xl" style="color: #AE1C9A"></i></span>
                                                </div>
                                                <div class="wrapper-content">
                                ...
                                <tbody>
                                    <tr class="table-row table-top-row">
                                        ...
                                        <td class="table-wrapper wrapper-price">
                                            <div class="table-wrapper-center">
                                                <h5 class="table-heading">{{ __('Unit Price') }}</h5>
                                            </div>
                                        </td>
